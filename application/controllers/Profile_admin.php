...
class Profilez extends MY_Controller
{
    ...
    {
        $this->form_validation->set_rules('name', 'Name', 'trim|required|min_length[4]|max_length[25]');
        $this->form_validation->set_rules('alamat', 'Address', 'trim|required|min_length[2]|max_length[50]');
        $this->form_validation->set_rules('no_telepon', 'Phone Number', 'trim|required|min_length[2]|max_length[15]');

...
<head>
    ...
    <!-- Google Web Fonts -->
    <link rel="preconnect" href="<?php echo base_url(); ?>assets/https://fonts.googleapis.com">
    <link rel="preconnect" href="<?php echo base_url(); ?>assets/https://fonts.gstatic.com" crossorigin>
    ...
    <link href="<?php echo base_url(); ?>assets/https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.10.0/css/all.min.css" rel="stylesheet">
    <link href="<?php echo base_url(); ?>assets/https://cdn.jsdelivr.net/npm/bootstrap-icons@1.4.1/font/bootstrap-icons.css" rel="stylesheet">
...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="51">
                    ...
                    <div class="row g-5">
                        ...
                        <div class="col-lg-4 d-flex justify-content-center justify-content-lg-end wow fadeInUp" data-wow-delay="0.3s">
                            <div class="owl-carousel screenshot-carousel">
                                <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/screenshot-1.png" alt="">
                                <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/screenshot-2.png" alt="">
                                <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/screenshot-3.png" alt="">
                                <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/screenshot-4.png" alt="">
                                <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/screenshot-5.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-xxl py-5" id="about">
            <div class="container py-5 px-lg-5">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        <img class="img-fluid wow fadeInUp" data-wow-delay="0.5s" src="<?=base_url(); ?>assets/img/about.png">
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="<?php echo base_url(); ?>assets/https://code.jquery.com/jquery-3.4.1.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/https://cdn.jsdelivr.net/npm/bootstrap@5.0.0/dist/js/bootstrap.bundle.min.js"></script>

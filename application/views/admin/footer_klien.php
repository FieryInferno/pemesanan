...
success: function(){
    document.lacation.href = "<?= base_url('admin/roleaccess/');  ?>" + roleId; 
}
});
});
   </script>
...
<script src="<?=base_url(); ?>assets4/plugins/sweetalert2/sweetalert2.min.js"></script>
<script>
  $(function() {
    ...
    $('.swalDefaultSuccess').click(function() {
      Toast.fire({
        icon: 'success',
        title: 'Pesanan Anda Berhasil Ditambahkan Pada Keranjang.'
      })
    });
      });
       </script>
...
<div id="content-wrapper" class="d-flex flex-column">
                               ...
                               <?php }else{
                                ...
                                <a class="dropdown-item d-flex align-items-center">
                                    <div class="dropdown-list-image mr-3">
                                        ...
                                        <img class="rounded-circle" src="<?=base_url(); ?>assets2/img/time.jpg"
                                            alt="...">
    ...
    <i class="fa fa-calculator"></i>&nbsp;Rp. <?= $this->cart->format_number($value['subtotal'], 0,',','.');?>
    </p>
                                    </div>
                                </a>
...
<center><a class="dropdown-item dropdown-footer" href="<?php echo base_url('pesan/cart'); ?>">View Cart</a></center> 

...
<i class="bi bi-broadcast"></i>
        ...
        <!-- End of Sidebar -->   <div id="content-wrapper" class="d-flex flex-column">
...
Olivia</span><img class="img-profile rounded-circle" src="http://localhost/Pemesanan_iklan/assets/img/profile/default.jpg">
                            </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="http://localhost/Pemesanan_iklan/auth/logout" data-toggle="modal" data-target="#logoutModal">
...
<br><br>
                    ...
                    <!-- Page Heading -->
        <center> <b><h1 class="h3 mb-4 text-gray-800">Profile</h1></b></center>
<br>
<center><div class="card mb-3" style="max-width: 540px;">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="http://localhost/Pemesanan_iklan/assets/img/profile/default.jpg" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="http://localhost/Pemesanan_iklan/auth/logout">Logout</a>
                </div>
            </div>
        </div>
    </div>

...
<html lang="en">
  ...
  <head>
    ...
    <title>Pemesanan Iklan RRI Jayapura</title>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/templatemo-digimedia-v3.css">
        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <a href="index.html" class="logo">
              <img src="<?php echo base_url(); ?>assets/images/logo-v3.png" alt="">
            </a>
            <!-- ***** Logo End ***** -->
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <img src="<?php echo base_url(); ?>assets/images/slider-dec-v3.png" alt="">
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="about-left-image  wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                <img src="<?php echo base_url(); ?>assets/images/about-dec-v3.png" alt="">
              </div>
            </div>
                ...
                <div class="col-lg-12">
                  <div class="menu">
                    <div class="first-thumb active">
                      <div class="thumb">
                        <span class="icon"><img src="<?php echo base_url(); ?>assets/images/service-icon-01.png" alt=""></span>
                        Apartments
                      </div>
                    </div>
                    <div>
                      <div class="thumb">                 
                        <span class="icon"><img src="<?php echo base_url(); ?>assets/images/service-icon-02.png" alt=""></span>
                        Food &amp; Life
                      </div>
                    </div>
                    <div>
                      <div class="thumb">                 
                        <span class="icon"><img src="<?php echo base_url(); ?>assets/images/service-icon-03.png" alt=""></span>
                        Cars
                      </div>
                    </div>
                    <div>
                      <div class="thumb">                 
                        <span class="icon"><img src="<?php echo base_url(); ?>assets/images/service-icon-04.png" alt=""></span>
                        Shopping
                      </div>
                    </div>
                      ...
                      <div>
                        <div class="thumb">
                          <div class="row">
                            ...
                            <div class="col-lg-6 align-self-center">
                              <div class="right-image">
                                <img src="<?php echo base_url(); ?>assets/images/services-image-02.jpg" alt="">
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div>
                        <div class="thumb">
                          <div class="row">
                            ...
                            <div class="col-lg-6 align-self-center">
                              <div class="right-image">
                                <img src="<?php echo base_url(); ?>assets/images/services-image-03.jpg" alt="">
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div>
                        <div class="thumb">
                          <div class="row">
                            ...
                            <div class="col-lg-6 align-self-center">
                              <div class="right-image">
                                <img src="<?php echo base_url(); ?>assets/images/services-image-04.jpg" alt="">
                              </div>
                            </div>
                          </div>
                        </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 show-up wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
          <div class="blog-post">
            <div class="thumb">
              <a href="#"><img src="<?php echo base_url(); ?>assets/images/blog-post-01.jpg" alt=""></a>
            </div>
            <div class="down-content">
              ...
              <span class="author"><img src="<?php echo base_url(); ?>assets/images/author-post.jpg" alt="">By: Andrea Mentuzi</span>
          ...
          <div class="blog-posts">
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="post-item">
                  <div class="thumb">
                    <a href="#"><img src="<?php echo base_url(); ?>assets/images/blog-post-03.jpg" alt=""></a>
                  </div>
                  <div class="right-content">
                    <span class="category">SEO Analysis</span>
                    <span class="date">24 September 2021</span>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="contact-dec">
                  <img src="<?php echo base_url(); ?>assets/images/contact-dec-v3.png" alt="">
                </div>
              </div>
              <div class="col-lg-5">
                <div id="map">
                ...
                <div class="fill-form">
                  <div class="row">
                    ...
                    <div class="col-lg-4">
                      <div class="info-post">
                        <div class="icon">
                          <img src="<?php echo base_url(); ?>assets/images/email-icon.png" alt="">
